...
@Command(name = "logout",
        ...
        description = {"Removes both ways of being signed in, the OAuth tokens and the cookie login, because leaving one behind is not a logout. The client registration for this machine is kept, so the next login does not have to register again.",
            "",
